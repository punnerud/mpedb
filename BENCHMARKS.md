...
more as listeners scale 1 -> 100, where mpedb stays flat. mpedb's notification
costs nothing on any arm measured, and notification latency differs by 23-67x.
Run it with `mpedb-bench --notify`.
